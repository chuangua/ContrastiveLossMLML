...
def resnet18(pretrained: bool = False, progress: bool = True, num_classes:int=None  ,**kwargs):
...
def resnet50(pretrained: bool = False, progress: bool = True, num_classes: int=None , **kwargs):
